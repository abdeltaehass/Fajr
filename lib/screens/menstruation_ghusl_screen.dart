...
class MenstruationGhuslScreen extends StatefulWidget {
  const MenstruationGhuslScreen({super.key});

  @override
  State<MenstruationGhuslScreen> createState() =>
      _MenstruationGhuslScreenState();
}

class _MenstruationGhuslScreenState extends State<MenstruationGhuslScreen>
